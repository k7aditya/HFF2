...
class InvertedResidualBlock3D(nn.Module):
    def __init__(self, in_channels, out_channels, expand_ratio, stride=1, use_se=False, activation='RE'):
        super().__init__()
        self.stride = stride
...
class MobileNetV3Encoder3D(nn.Module):
    def __init__(self, in_channels):
        ...
        self.enc1 = InvertedResidualBlock3D(16, 16, expand_ratio=1, stride=1, use_se=True, activation='RE')
        self.enc2 = InvertedResidualBlock3D(16, 32, expand_ratio=4.5, stride=2, use_se=False, activation='RE')
        self.enc3 = InvertedResidualBlock3D(32, 64, expand_ratio=4, stride=2, use_se=True, activation='HS')
        self.enc4 = InvertedResidualBlock3D(64, 128, expand_ratio=6, stride=2, use_se=True, activation='HS')
        self.enc5 = InvertedResidualBlock3D(128, 256, expand_ratio=6, stride=2, use_se=True, activation='HS')
    def forward(self, x):
        x = self.stem(x)
        f1 = self.enc1(x)
        f2 = self.enc2(f1)
...
class HFFNet(nn.Module):
    def __init__(self, in_chs1, in_chs2, num_classes):
        ...
        self.mobilenet_encoder_b1 = MobileNetV3Encoder3D(in_chs1)
        self.mobilenet_encoder_b2 = MobileNetV3Encoder3D(in_chs2)
        self.l4_b1_2 = InvertedResidualBlock3D(128, 128, expand_ratio=4, stride=1, use_se=True, activation='HS')
        self.l4_b1_d2 = DownsampleConv(128, 128)
        self.l4_b1_s = SameSizeConv(128, 128)
        self.l4_b1_t = TransitionConv(128 + 256 + 128, 128)
        self.l4_b1_3 = InvertedResidualBlock3D(128, 128, expand_ratio=4, stride=1, use_se=True, activation='HS')
        self.l4_b1_4 = CustomBlock(128 + 128, 128, downsample=nn.Sequential(conv1x1(128 + 128, 128), BatchNorm3d(128, momentum=BN_MOMENTUM)))
        self.l4_b1_u = UpsampleConv(128, 64)
        self.l5_b1_1 = InvertedResidualBlock3D(256, 256, expand_ratio=6, stride=1, use_se=True, activation='HS')
        self.l5_b1_u = UpsampleConv(256, 256)
        self.l5_b1_s = SameSizeConv(256, 256)
        self.l5_b1_t = TransitionConv(256 + 256 + 128, 256)
        self.l5_b1_2 = InvertedResidualBlock3D(256, 256, expand_ratio=6, stride=1, use_se=True, activation='HS')
        self.l5_b1_u2 = UpsampleConv(256, 128)
        self.l3_b1_2 = CustomBlock(64 + 64, 64, downsample=nn.Sequential(conv1x1(64 + 64, 64), BatchNorm3d(64, momentum=BN_MOMENTUM)))
        self.l3_b1_u = UpsampleConv(64, 32)
        self.l2_b1_2 = CustomBlock(32 + 32, 32, downsample=nn.Sequential(conv1x1(32 + 32, 32), BatchNorm3d(32, momentum=BN_MOMENTUM)))
        self.l2_b1_u = UpsampleConv(32, 16)
        self.l1_b1_2 = CustomBlock(16 + 16, 16, downsample=nn.Sequential(conv1x1(16 + 16, 16), BatchNorm3d(16, momentum=BN_MOMENTUM)))
        self.l1_b1_f = nn.Conv3d(16, num_classes, 1)
        self.l4_b2_2 = InvertedResidualBlock3D(128, 128, expand_ratio=4, stride=1, use_se=True, activation='HS')
        self.l4_b2_d2 = DownsampleConv(128, 128)
        self.l4_b2_s = SameSizeConv(128, 128)
        self.l4_b2_t = TransitionConv(128 + 256 + 128, 128)
        self.l4_b2_3 = InvertedResidualBlock3D(128, 128, expand_ratio=4, stride=1, use_se=True, activation='HS')
        self.l4_b2_4 = CustomBlock(128 + 128, 128, downsample=nn.Sequential(conv1x1(128 + 128, 128), BatchNorm3d(128, momentum=BN_MOMENTUM)))
        self.l4_b2_u = UpsampleConv(128, 64)
        self.l5_b2_1 = InvertedResidualBlock3D(256, 256, expand_ratio=6, stride=1, use_se=True, activation='HS')
        self.l5_b2_u = UpsampleConv(256, 256)
        self.l5_b2_s = SameSizeConv(256, 256)
        self.l5_b2_t = TransitionConv(256 + 256 + 128, 256)
        self.l5_b2_2 = InvertedResidualBlock3D(256, 256, expand_ratio=6, stride=1, use_se=True, activation='HS')
        self.l5_b2_u2 = UpsampleConv(256, 128)
        self.l3_b2_2 = CustomBlock(64 + 64, 64, downsample=nn.Sequential(conv1x1(64 + 64, 64), BatchNorm3d(64, momentum=BN_MOMENTUM)))
        self.l3_b2_u = UpsampleConv(64, 32)
        self.l2_b2_2 = CustomBlock(32 + 32, 32, downsample=nn.Sequential(conv1x1(32 + 32, 32), BatchNorm3d(32, momentum=BN_MOMENTUM)))
        self.l2_b2_u = UpsampleConv(32, 16)
        self.l1_b2_2 = CustomBlock(16 + 16, 16, downsample=nn.Sequential(conv1x1(16 + 16, 16), BatchNorm3d(16, momentum=BN_MOMENTUM)))
    ...
    def forward(self, input1, input2):
        ...
        # Mixer/Decoder downstream unchanged
...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("MODIFIED HFF-NET WITH MOBILENETV3-SMALL ENCODER")
    print("=" * 80)
