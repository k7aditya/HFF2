    ...
    def __init__(self, in_channels, out_channels, expand_ratio, stride=1, use_se=False, activation='RE', dropout_p=0.0):
        ...
        if expand_ratio != 1:
            layers.extend([
                ...
                act(inplace=True),
                nn.Dropout3d(p=dropout_p)  # ADD DROPOUT after expansion
            ])
        else:
        ...
        layers.extend([
            ...
            BatchNorm3d(hidden_dim, momentum=BN_MOMENTUM),
            act(inplace=True),
            nn.Dropout3d(p=dropout_p)  # ADD DROPOUT after depthwise conv
        ])
        if use_se:
...
class MobileNetV3Encoder3D(nn.Module):
    def __init__(self, in_channels, dropout_p=0.0):
        ...
        self.stem = nn.Sequential(
            ...
            nn.Dropout3d(p=dropout_p)  # ADD DROPOUT in stem
        )
...
class UpsampleConv(nn.Module):
    def __init__(self, in_chs, out_chs, dropout_p=0.0):
        ...
        self.up = nn.Sequential(
            ...
            nn.Dropout3d(p=dropout_p)  # ADD DROPOUT in decoder
        )
    def forward(self, x):
        return self.up(x)
...
class DownsampleConv(nn.Module):
    def __init__(self, in_chs, out_chs, dropout_p=0.0):
        ...
        self.down = nn.Sequential(
            ...
            BatchNorm3d(out_chs, momentum=BN_MOMENTUM),
            ActivationFunction(inplace=relu_inplace),
            nn.Dropout3d(p=dropout_p)  # ADD DROPOUT
        )
    def forward(self, x):
        return self.down(x)
...
class CustomBlock(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, stride=1, downsample=None, norm_layer=BatchNorm3d, dropout_p=0.0):
        ...
        self.dropout = nn.Dropout3d(p=dropout_p)  # ADD DROPOUT
...
class HFFNet(nn.Module):
    def __init__(self, in_chs1, in_chs2, num_classes, dropout_p=0.1):
        ...
        self.x1_3side = SideTransition(dropout_p=dropout_p)
        self.x2_3side = SideTransition(dropout_p=dropout_p)
        ...
        self.l4_b1_2 = InvertedResidualBlock3D(128, 128, expand_ratio=4, stride=1, use_se=True, activation='HS', dropout_p=dropout_p)
        self.l4_b1_d2 = DownsampleConv(128, 128, dropout_p=dropout_p)
        self.l4_b1_s = SameSizeConv(128, 128, dropout_p=dropout_p)
        self.l4_b1_t = TransitionConv(128 + 256 + 128, 128, dropout_p=dropout_p)
        self.l4_b1_3 = InvertedResidualBlock3D(128, 128, expand_ratio=4, stride=1, use_se=True, activation='HS', dropout_p=dropout_p)
        self.l4_b1_4 = CustomBlock(128 + 128, 128, downsample=nn.Sequential(conv1x1(128 + 128, 128), BatchNorm3d(128, momentum=BN_MOMENTUM)), dropout_p=dropout_p)
        self.l4_b1_u = UpsampleConv(128, 64, dropout_p=dropout_p)
        self.l5_b1_1 = InvertedResidualBlock3D(256, 256, expand_ratio=6, stride=1, use_se=True, activation='HS', dropout_p=dropout_p)
        self.l5_b1_u = UpsampleConv(256, 256, dropout_p=dropout_p)
        self.l5_b1_s = SameSizeConv(256, 256, dropout_p=dropout_p)
        self.l5_b1_t = TransitionConv(256 + 256 + 128, 256, dropout_p=dropout_p)
        self.l5_b1_2 = InvertedResidualBlock3D(256, 256, expand_ratio=6, stride=1, use_se=True, activation='HS', dropout_p=dropout_p)
        self.l5_b1_u2 = UpsampleConv(256, 128, dropout_p=dropout_p)
        self.l3_b1_2 = CustomBlock(64 + 64, 64, downsample=nn.Sequential(conv1x1(64 + 64, 64), BatchNorm3d(64, momentum=BN_MOMENTUM)), dropout_p=dropout_p)
        ...
        self.l4_b2_s = SameSizeConv(128, 128, dropout_p=dropout_p)
        self.l4_b2_t = TransitionConv(128 + 256 + 128, 128, dropout_p=dropout_p)
        self.l4_b2_3 = InvertedResidualBlock3D(128, 128, expand_ratio=4, stride=1, use_se=True, activation='HS', dropout_p=dropout_p)
        self.l4_b2_4 = CustomBlock(128 + 128, 128, downsample=nn.Sequential(conv1x1(128 + 128, 128), BatchNorm3d(128, momentum=BN_MOMENTUM)), dropout_p=dropout_p)
        self.l4_b2_u = UpsampleConv(128, 64, dropout_p=dropout_p)
        self.l5_b2_1 = InvertedResidualBlock3D(256, 256, expand_ratio=6, stride=1, use_se=True, activation='HS', dropout_p=dropout_p)
        self.l5_b2_u = UpsampleConv(256, 256, dropout_p=dropout_p)
        self.l5_b2_s = SameSizeConv(256, 256, dropout_p=dropout_p)
        self.l5_b2_t = TransitionConv(256 + 256 + 128, 256, dropout_p=dropout_p)
        self.l5_b2_2 = InvertedResidualBlock3D(256, 256, expand_ratio=6, stride=1, use_se=True, activation='HS', dropout_p=dropout_p)
        self.l5_b2_u2 = UpsampleConv(256, 128, dropout_p=dropout_p)
        self.l3_b2_2 = CustomBlock(64 + 64, 64, downsample=nn.Sequential(conv1x1(64 + 64, 64), BatchNorm3d(64, momentum=BN_MOMENTUM)), dropout_p=dropout_p)
...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("MODIFIED HFF-NET WITH MOBILENETV3-SMALL ENCODER + MC-DROPOUT SUPPORT")
    print("=" * 80)
